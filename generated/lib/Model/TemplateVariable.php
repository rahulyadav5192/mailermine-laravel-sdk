...
class TemplateVariable implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets name
     *
     * @param string $name Variable identifier used in `{{name}}` placeholders. @example first_name
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string $type Variable validation type. @var 'string'|'number'|'email'|'url' @example string
     *
     * @return self
     */
     ...
     * Sets required
     *
     * @param bool $required Whether callers must provide a value. @example true
     *
     * @return self
     */
     ...
     * Sets default_value
     *
     * @param string|null $default_value Optional fallback value. @example Customer
     *
     * @return self
     */
