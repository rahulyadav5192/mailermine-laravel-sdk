...
class CreateDomainRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets domain
     *
     * @param string $domain Root domain or sending subdomain.
     *
     * @return self
     */
    public function setDomain($domain)
    {
        ...
        if ((mb_strlen($domain) > 255)) {
            throw new \InvalidArgumentException('invalid length for $domain when calling CreateDomainRequest., must be smaller than or equal to 255.');
        }
        if ((!preg_match("/^(?:[a-z0-9](?:[a-z0-9-]{0,61}[a-z0-9])?\\.)+[a-z0-9][a-z0-9-]{0,61}[a-z0-9]$/", ObjectSerializer::toString($domain)))) {
            throw new \InvalidArgumentException("invalid value for \$domain when calling CreateDomainRequest., must conform to the pattern /^(?:[a-z0-9](?:[a-z0-9-]{0,61}[a-z0-9])?\\.)+[a-z0-9][a-z0-9-]{0,61}[a-z0-9]$/.");
        }
