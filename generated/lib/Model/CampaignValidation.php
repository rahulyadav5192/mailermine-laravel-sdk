...
/**
 * CampaignValidation Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CampaignValidation implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CampaignValidation';
     ...
     * Sets errors
     *
     * @param mixed[] $errors Blocking validation messages. @var list<string>
     *
     * @return self
     */
     ...
     * Sets warnings
     *
     * @param mixed[] $warnings Non-blocking validation messages. @var list<string>
     *
     * @return self
     */
