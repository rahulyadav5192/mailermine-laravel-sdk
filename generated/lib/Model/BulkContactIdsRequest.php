...
/**
 * BulkContactIdsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BulkContactIdsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BulkContactIdsRequest';
    ...
    public function setIds($ids)
    {
        ...
        if ((count($ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ids when calling BulkContactIdsRequest., number of items must be greater than or equal to 1.');
        }
