...
class UpdateContactRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets email
     *
     * @param string|null $email Replacement email address.
     *
     * @return self
     */
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling UpdateContactRequest., must be smaller than or equal to 255.');
        }
     ...
     * Sets first_name
     *
     * @param string|null $first_name Replacement given name.
     *
     * @return self
     */
    public function setFirstName($first_name)
    {
        ...
        if (!is_null($first_name) && (mb_strlen($first_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling UpdateContactRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if (!is_null($last_name) && (mb_strlen($last_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling UpdateContactRequest., must be smaller than or equal to 255.');
        }
     ...
     * Sets status
     *
     * @param string|null $status Replacement lifecycle status.
     *
     * @return self
     */
     ...
     * Sets subscribed
     *
     * @param bool|null $subscribed Replacement subscription state.
     *
     * @return self
     */
     ...
     * Sets metadata
     *
     * @param object|null $metadata Replacement metadata object when present.
     *
     * @return self
     */
     ...
     * Sets list_ids
     *
     * @param string[]|null $list_ids list_ids
     *
     * @return self
     */
     ...
     * Sets tag_names
     *
     * @param string[]|null $tag_names tag_names
     *
     * @return self
     */
     ...
     * Sets custom_fields
     *
     * @param object|null $custom_fields Replacement custom-field map when present.
     *
     * @return self
     */
