...
/**
 * WebhookDeliveryMessage Class Doc Comment
 *
 * @category Class
 * @description Related message summary, when the delivery is tied to a message.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class WebhookDeliveryMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'WebhookDelivery_message';
