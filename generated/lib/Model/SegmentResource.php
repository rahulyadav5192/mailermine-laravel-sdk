...
/**
 * SegmentResource Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SegmentResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SegmentResource';
     ...
     * Sets id
     *
     * @param string $id Public segment UUID. @format uuid
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Project-unique segment name. @example Active customers
     *
     * @return self
     */
     ...
     * Sets rules
     *
     * @param mixed[] $rules Normalized dynamic membership rules. @var array<string, mixed>
     *
     * @return self
     */
     ...
     * Sets contact_count
     *
     * @param int $contact_count Last evaluated matching contact count. @example 342
     *
     * @return self
     */
