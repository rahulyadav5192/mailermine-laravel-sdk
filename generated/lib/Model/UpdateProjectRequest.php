...
class UpdateProjectRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling UpdateProjectRequest., must be smaller than or equal to 255.');
        }
     ...
     * Sets slug
     *
     * @param string|null $slug Updated lowercase kebab-case slug.
     *
     * @return self
     */
    public function setSlug($slug)
    {
        ...
        if (!is_null($slug) && (mb_strlen($slug) > 255)) {
            throw new \InvalidArgumentException('invalid length for $slug when calling UpdateProjectRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($slug) && (!preg_match("/^[a-z0-9]+(?:-[a-z0-9]+)*$/", ObjectSerializer::toString($slug)))) {
            throw new \InvalidArgumentException("invalid value for \$slug when calling UpdateProjectRequest., must conform to the pattern /^[a-z0-9]+(?:-[a-z0-9]+)*$/.");
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling UpdateProjectRequest., must be smaller than or equal to 2000.');
        }
     ...
     * Sets default_sender
     *
     * @param string|null $default_sender Default sender; null clears it.
     *
     * @return self
     */
    public function setDefaultSender($default_sender)
    {
        ...
        if (!is_null($default_sender) && (mb_strlen($default_sender) > 255)) {
            throw new \InvalidArgumentException('invalid length for $default_sender when calling UpdateProjectRequest., must be smaller than or equal to 255.');
        }
     ...
     * Sets settings
     *
     * @param object|null $settings Replacement settings object.
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param string|null $status Archive or restore the project.
     *
     * @return self
     */
