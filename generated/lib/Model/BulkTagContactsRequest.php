...
/**
 * BulkTagContactsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BulkTagContactsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BulkTagContactsRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['tag_ids']) < 1)) {
            $invalidProperties[] = "invalid value for 'tag_ids', number of items must be greater than or equal to 1.";
        }
     ...
     * Sets contact_ids
     *
     * @param string[] $contact_ids Contact UUIDs to mutate.
     *
     * @return self
     */
    public function setContactIds($contact_ids)
    {
        ...
        if ((count($contact_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $contact_ids when calling BulkTagContactsRequest., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets tag_ids
     *
     * @param string[] $tag_ids Tag UUIDs to assign or remove.
     *
     * @return self
     */
    public function setTagIds($tag_ids)
    {
        ...
        if ((count($tag_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $tag_ids when calling BulkTagContactsRequest., number of items must be greater than or equal to 1.');
        }
