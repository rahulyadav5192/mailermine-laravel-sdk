...
/**
 * AudienceResource Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AudienceResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AudienceResource';
     ...
     * Sets type
     *
     * @param string $type Audience backing type. @var 'list'|'segment' @example list
     *
     * @return self
     */
     ...
     * Sets id
     *
     * @param string $id Public list or segment UUID. @format uuid
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Audience name. @example Product newsletter
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Optional audience description.
     *
     * @return self
     */
     ...
     * Sets member_count
     *
     * @param int $member_count Current list size or last evaluated segment size. @example 1250
     *
     * @return self
     */
     ...
     * Sets source
     *
     * @param string $source Backing resource discriminator. @var 'list'|'segment' @example list
     *
     * @return self
     */
