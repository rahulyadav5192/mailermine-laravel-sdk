...
class CreateCustomFieldRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CreateCustomFieldRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateCustomFieldRequest., must be smaller than or equal to 1000.');
        }
    ...
    public function setDefaultValue($default_value)
    {
        ...
        if (!is_null($default_value) && (mb_strlen($default_value) > 5000)) {
            throw new \InvalidArgumentException('invalid length for $default_value when calling CreateCustomFieldRequest., must be smaller than or equal to 5000.');
        }
