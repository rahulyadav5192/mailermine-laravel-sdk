...
class TagResource implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets id
     *
     * @param string $id Public tag UUID. @format uuid @example 8cb52aa6-b31c-4b87-8f63-11408ea21c72
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Project-unique tag name. @example vip
     *
     * @return self
     */
     ...
     * Sets color
     *
     * @param string $color Display color in hex notation. @example #7C3AED
     *
     * @return self
     */
     ...
     * Sets usage_count
     *
     * @param int $usage_count Number of contacts using the tag. @example 42
     *
     * @return self
     */
