...
class CreateContactRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('subscribed', $data ?? [], true);
        $this->setIfExists('source', $data ?? [], 'api');
        $this->setIfExists('metadata', $data ?? [], null);
        $this->setIfExists('list_ids', $data ?? [], null);
        $this->setIfExists('tag_ids', $data ?? [], null);
        $this->setIfExists('tag_names', $data ?? [], null);
     ...
     * Sets email
     *
     * @param string $email Unique email address within the project.
     *
     * @return self
     */
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 255)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CreateContactRequest., must be smaller than or equal to 255.');
        }
     ...
     * Sets first_name
     *
     * @param string|null $first_name Given name.
     *
     * @return self
     */
    public function setFirstName($first_name)
    {
        ...
        if (!is_null($first_name) && (mb_strlen($first_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling CreateContactRequest., must be smaller than or equal to 255.');
        }
     ...
     * Sets last_name
     *
     * @param string|null $last_name Family name.
     *
     * @return self
     */
    public function setLastName($last_name)
    {
        ...
        if (!is_null($last_name) && (mb_strlen($last_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling CreateContactRequest., must be smaller than or equal to 255.');
        }
     ...
     * Sets status
     *
     * @param string|null $status Initial contact lifecycle status.
     *
     * @return self
     */
     ...
     * Sets subscribed
     *
     * @param bool|null $subscribed Initial marketing subscription state.
     *
     * @return self
     */
     ...
     * Sets source
     *
     * @param string|null $source Acquisition source.
     *
     * @return self
     */
    public function setSource($source)
    {
        ...
        if (!is_null($source) && (mb_strlen($source) > 64)) {
            throw new \InvalidArgumentException('invalid length for $source when calling CreateContactRequest., must be smaller than or equal to 64.');
        }
     ...
     * Sets metadata
     *
     * @param object|null $metadata Caller-defined metadata object.
     *
     * @return self
     */
     ...
     * Sets list_ids
     *
     * @param string[]|null $list_ids List UUIDs to assign.
     *
     * @return self
     */
    ...
    {
        if (is_null($list_ids)) {
            array_push($this->openAPINullablesSetToNull, 'list_ids');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('list_ids', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets tag_ids
     *
     * @param string[]|null $tag_ids Existing tag UUIDs to assign.
     *
     * @return self
     */
     ...
     * Sets tag_names
     *
     * @param string[]|null $tag_names Tag names to resolve or create.
     *
     * @return self
     */
    public function setTagNames($tag_names)
    {
        if (is_null($tag_names)) {
            array_push($this->openAPINullablesSetToNull, 'tag_names');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tag_names', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets custom_fields
     *
     * @param object|null $custom_fields Custom values keyed by field slug.
     *
     * @return self
     */
