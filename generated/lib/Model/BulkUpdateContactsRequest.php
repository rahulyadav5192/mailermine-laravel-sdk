...
/**
 * BulkUpdateContactsRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class BulkUpdateContactsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BulkUpdateContactsRequest';
     ...
     * Sets ids
     *
     * @param string[] $ids Contact UUIDs to update.
     *
     * @return self
     */
    public function setIds($ids)
    {
        ...
        if ((count($ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $ids when calling BulkUpdateContactsRequest., number of items must be greater than or equal to 1.');
        }
     ...
     * Sets status
     *
     * @param string $status Status applied to every selected contact.
     *
     * @return self
     */
