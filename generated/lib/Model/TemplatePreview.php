...
class TemplatePreview implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets subject
     *
     * @param string $subject Rendered subject. @example Welcome Alex
     *
     * @return self
     */
     ...
     * Sets html
     *
     * @param string|null $html Rendered HTML body. @example <p>Hello Alex</p>
     *
     * @return self
     */
     ...
     * Sets text
     *
     * @param string|null $text Rendered plain-text body. @example Hello Alex
     *
     * @return self
     */
