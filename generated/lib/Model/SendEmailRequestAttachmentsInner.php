...
class SendEmailRequestAttachmentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setFilename($filename)
    {
        ...
        if ((mb_strlen($filename) > 255)) {
            throw new \InvalidArgumentException('invalid length for $filename when calling SendEmailRequestAttachmentsInner., must be smaller than or equal to 255.');
        }
    ...
    public function setContentType($content_type)
    {
        ...
        if (!is_null($content_type) && (mb_strlen($content_type) > 255)) {
            throw new \InvalidArgumentException('invalid length for $content_type when calling SendEmailRequestAttachmentsInner., must be smaller than or equal to 255.');
        }
